...
#define gameUpdateHz (monitorRefreshHz / 2)
	...
	if (windowHandle)
	{
	    ...
	    void* gameMemoryBlock = VirtualAlloc(baseAddress, (size_t)win32State.totalSize, MEM_RESERVE|MEM_COMMIT, PAGE_READWRITE);
	    win32State.gameMemoryBlock = gameMemoryBlock;
